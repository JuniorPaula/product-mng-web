<template>
  <div class="flex flex-row h-screen w-screen">
    <div class="basis-1/2 flex flex-col justify-center items-center bg-gray-800 w-screen text-white">
      <h3 class="block font-sans text-5xl antialiased font-semibold leading-snug tracking-normal text-blue-gray-900">
        Inventório de Produtos
      </h3>
      <p class="block mt-4 font-sans text-lg antialiased font-normal leading-relaxed tracking-normal text-blue-gray-900">
        A melhor gestão de produtos para o seu negócio.
      </p>
    </div>
    <div class="basis-1/2 flex justify-center items-center">
      <div class="relative flex flex-col text-gray-700 bg-transparent shadow-none rounded-xl bg-clip-border">
        ...
        <form @submit="submitHandler" class="max-w-screen-lg mt-8 mb-2 w-80 sm:w-96">
          <div class="flex flex-col gap-6 mb-1">
            ...
            <div class="relative h-11 w-full min-w-[200px]">
              <input v-model="email" type="email" placeholder="name@mail.com"
...
import { Security } from "../request/security.js";
...
export default {
  ...
  methods: {
    submitHandler(event) {
      ...
      fetch(`${configs.API_URL}/login`, Security.requestOptions(payload, "POST"))
